...
export function folioPayCopy(kind: OrderLocationKind) {
  if (kind === "public") {
    return {
      ...
      unpaidHintUnset:
        "Pay now, pay at the counter, or charge to your room after entering the check-in code from reception.",
  ...
  return {
    ...
    unpaidHintChargeRoom: "You'll settle this at checkout — charged to your room / desk. No card needed in the app.",
    payNowActive: "Team notified",
    payNowIdle: "Pay now",
