...
/** Every active ISO 4217 currency (precious-metal and IMF-only codes like
 *  XAU/XDR excluded — no property bills a guest in those). A curated
 *  shortlist here meant any property outside a dozen big economies had
 *  nothing to pick; this is the real global set instead. */
export const CURRENCY_OPTIONS: { code: string; label: string }[] = [
  ...
  { code: "MMK", label: "MMK — Myanma Kyat" },
